...
class CytoscapeRenderer:
    ...
    def __init__(self):
        ...
        self.base_styles = [
            ...
            # Chain nodes
            CytoscapeStyle("node[type = 'sequential_chain']", {
                "background-color": "#E8F5E9",
                "border-color": "#66BB6A",
                "border-width": "2px",
            }),
            CytoscapeStyle("node[type = 'parallel_chain']", {
                "background-color": "#E3F2FD",
                "border-color": "#42A5F5",
                "border-width": "2px",
            }),
            CytoscapeStyle("node[type = 'chord_chain']", {
                "background-color": "#F3E5F5",
                "border-color": "#AB47BC",
                "border-width": "2px",
            }),
            CytoscapeStyle("node[type = 'group_chain']", {
                "background-color": "#FFF3E0",
                "border-color": "#FB8C00",
                "border-width": "2px",
            }),
            CytoscapeStyle("node[type = 'map_chain']", {
                "background-color": "#E0F7FA",
                "border-color": "#26C6DA",
                "border-width": "2px",
            }),
            CytoscapeStyle("node[type = 'reminder_chain']", {
                "background-color": "#F1F8E9",
                "border-color": "#7CB342",
                "border-width": "2px",
            }),
            CytoscapeStyle("node[type = 'recursive_chain']", {
            ...
            CytoscapeStyle("edge[label = 'contains']", {
                "line-style": "dashed",
                "line-color": "#BDBDBD",
                "target-arrow-color": "#BDBDBD",
            }),
            CytoscapeStyle("edge[label = 'next']", {
                "line-color": "#2196F3",
                "target-arrow-color": "#2196F3",
            }),
            CytoscapeStyle("edge[label = 'callback']", {
                "line-color": "#9C27B0",
                "target-arrow-color": "#9C27B0",
            }),
            CytoscapeStyle("edge[label = 'next_with_context']", {
                "line-color": "#4CAF50",
                "target-arrow-color": "#4CAF50",
            }),
            CytoscapeStyle("edge[label = 'may_recurse']", {
                "line-color": "#FF5722",
