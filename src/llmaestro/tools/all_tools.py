...
def register_sql_tools(
    engine_or_connection: Optional[Union[Engine, Connection, Callable[[], Union[Engine, Connection]]]] = None,
) -> None:
...
def register_placeholder_tools() -> None:
    ...
    placeholder_tools = {
        ...
        "api_integration_tools": {
            "category": "api",
            "tools": [("rest_api_call", "Make a REST API call."), ("graphql_query", "Execute a GraphQL query.")],
        },
...
def register_all_tools(
    sql_engine: Optional[Union[Engine, Connection, Callable[[], Union[Engine, Connection]]]] = None,
) -> None:
